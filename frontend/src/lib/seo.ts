...
const pageMeta: Record<string, Record<string, PageSEO>> = {
  home: {
    en: {
      title: "CyberSec Pro — Cloud Cybersecurity | 183 Kali Tools",
      description:
        "Run 183 Kali Linux security tools from your browser. Automated vulnerability scanning, penetration testing, and security assessments. No setup required. Start free.",
    },
    tr: {
      title: "CyberSec Pro — Bulut Siber Güvenlik Platformu | 183 Kali Linux Aracı",
      description:
        "183 Kali Linux güvenlik aracını tarayıcınızdan çalıştırın. Otomatik zafiyet tarama, penetrasyon testi ve güvenlik değerlendirmeleri. Kurulum gerektirmez.",
    },
  },
  about: {
    en: {
      ...
      description:
        "Built by security engineers for security engineers. Learn about CyberSec Pro's mission to democratize offensive security with 183 cloud-based Kali Linux tools.",
    },
    tr: {
      title: "Hakkımızda — CyberSec Pro Siber Güvenlik Platformu",
      description:
        "Güvenlik mühendisleri tarafından, güvenlik mühendisleri için yapıldı. 183 bulut tabanlı Kali Linux aracıyla saldırı güvenliğini demokratikleştirme misyonumuzu öğrenin.",
    },
  },
  "trust-center": {
    en: {
  ...
  tools: {
    en: {
      title: "183 Security Tools — Kali Linux Arsenal Online",
      description:
        "Access 183 Kali Linux security tools across 18 categories. Nmap, Metasploit, Burp Suite, SQLMap, Nikto, Hydra and more — all in your browser.",
    },
    tr: {
      title: "183 Güvenlik Aracı — Online Kali Linux Cephaneliği",
      description:
        "18 kategoride 183 Kali Linux güvenlik aracına erişin. Nmap, Metasploit, Burp Suite, SQLMap, Nikto, Hydra ve daha fazlası — hepsi tarayıcınızda.",
    },
  },
  blog: {
    en: {
  ...
  docs: {
    en: {
      ...
      description:
        "Complete guide to setting up scans, using 183 security tools, generating reports, and integrating CyberSec Pro into your workflow.",
    },
    tr: {
      title: "Dokümantasyon — CyberSec Pro ile Başlangıç Rehberi",
      description:
        "Tarama kurulumu, 183 güvenlik aracı kullanımı, rapor oluşturma ve CyberSec Pro entegrasyonu için kapsamlı rehber.",
    },
  },
  "api-reference": {
    en: {
...
export function getOrganizationJsonLd() {
  return {
    ...
    description: "Cloud-based offensive security platform with 183 Kali Linux tools.",
    founder: {
      "@type": "Person",
  ...
  return {
    ...
    offers: [
      ...
      },
      {
        ...
        priceCurrency: "EUR",
        name: "Starter",
        description: "All 183 tools, 30 scans/month, basic reports",
      },
      {
        "@type": "Offer",
        price: "99",
        priceCurrency: "EUR",
        name: "Professional",
        description: "All 183 tools, 250 scans/month, AI suggestions, compliance reports",
      },
      {
        "@type": "Offer",
        price: "349",
        priceCurrency: "EUR",
        name: "Enterprise",
        description: "All 183 tools, 5000 scans/month, SSO/SAML, priority support, dedicated manager",
      },
    ],
  };
}
