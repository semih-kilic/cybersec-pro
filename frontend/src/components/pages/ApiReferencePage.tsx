...
const groups: EndpointGroup[] = [
  ...
  },
  {
    ...
    description: "Browse, search, and configure the full arsenal of 778 verified Kali Linux security tools.",
    endpoints: [
      { method: "GET", path: "/api/v1/tools", description: "List all tools with pagination (default 50/page). Filter by category, name, status" },
      { method: "GET", path: "/api/v1/tools/count", description: "Get total tool count (returns { total: 778, active: N })" },
