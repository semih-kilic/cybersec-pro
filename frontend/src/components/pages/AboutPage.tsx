...
const values = [
  { icon: Shield, title: "Accessibility", desc: "89 verified Kali tools accessible through your browser. Plans start free — no VMs, no CLI dependencies, no complex setup." },
      ...
      <section className="mx-auto max-w-5xl px-6 pb-28">
        <RevealOnScroll>
          <div className="glass-card bg-gradient-to-r from-[var(--color-neon)]/5 to-transparent p-8 text-center">
            ...
            <p className="text-sm text-white/50 mb-6">Start scanning with 89 professional security tools. No credit card required.</p>
