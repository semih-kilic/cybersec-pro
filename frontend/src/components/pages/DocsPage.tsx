              ...
              <div className="glass-card p-8">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    { name: "Full Scan", desc: "All relevant tools from your plan tier (50-325 tools). Comprehensive assessment covering network, web, wireless, and application attack vectors. Can take 1-4 hours for large targets.", color: "var(--color-cyan)", time: "1-4 hours" },
...
[*] Scan completed: 1 host up, 3 ports open, 1 vuln found`}</pre>
        ...
        {activeSection === "tools" && (
          <div className="space-y-6">
            <RevealOnScroll>
              <div className="glass-card p-8">
                <h2 className="text-2xl font-bold text-white mb-2">Tool Arsenal — 325 Verified Kali Linux Tools</h2>
            ...
            <RevealOnScroll>
              <div className="glass-card p-8">
                ...
                <div className="grid gap-3 md:grid-cols-4">
                  {[
                    { plan: "Free Trial", count: "325", desc: "All tools, 1 scan, 3-day trial", color: "white/60" },
                    { plan: "Starter (€29/mo)", count: "325", desc: "1 domain, weekly scans, reports", color: "var(--color-neon)" },
                    { plan: "Professional (€99/mo)", count: "325", desc: "5 domains, API, compliance reports", color: "var(--color-cyan)" },
                    { plan: "Enterprise (€349/mo)", count: "325", desc: "Unlimited, SSO, dedicated support", color: "var(--color-purple)" },
                  ].map((p) => (
            ...
            <RevealOnScroll>
              <div className="glass-card p-8">
                ...
                <div className="grid gap-4 md:grid-cols-4">
                  {[
                    { metric: "325", label: "Security Tools" },
