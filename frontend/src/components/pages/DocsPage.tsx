            ...
            <RevealOnScroll>
              <div className="glass-card p-8">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  {[
                    { n: "1", title: "Create Account", desc: "Register at semihkilic.com with your email address or GitHub OAuth. Verify your email to activate. You'll receive a 14-day free trial with access to basic scanning tools." },
              ...
              <div className="glass-card p-8">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    { name: "Full Scan", desc: "All relevant tools from your plan tier (50-401 tools). Comprehensive assessment covering network, web, wireless, and application attack vectors. Can take 1-4 hours for large targets.", color: "var(--color-cyan)", time: "1-4 hours" },
...
[*] Scan completed: 1 host up, 3 ports open, 1 vuln found`}</pre>
        ...
        {activeSection === "tools" && (
          <div className="space-y-6">
            <RevealOnScroll>
              <div className="glass-card p-8">
                <h2 className="text-2xl font-bold text-white mb-2">Tool Arsenal — 401 Verified Kali Linux Tools</h2>
              ...
              <div className="glass-card p-8">
                ...
                <div className="grid gap-3 md:grid-cols-4">
                  {[
                    ...
                    { plan: "Enterprise (€799)", count: "401", desc: "Complete Kali arsenal + custom", color: "var(--color-purple)" },
                  ].map((p) => (
