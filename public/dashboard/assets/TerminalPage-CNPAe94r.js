import{j as e}from"./index-52DdXTCs.js";import{r as o}from"./router-CDeefzIX.js";import{H as k}from"./Header-DO6SGG0u.js";function T(){const p=o.useRef(null),u=o.useRef(null),[m,n]=o.useState([{type:"output",content:"╔════════════════════════════════════════════════════════════════╗"},{type:"output",content:"║     ██╗  ██╗ █████╗ ██╗     ██╗    ██████╗ ██████╗  ██████╗    ║"},{type:"output",content:"║     ██║ ██╔╝██╔══██╗██║     ██║    ██╔══██╗██╔══██╗██╔═══██╗   ║"},{type:"output",content:"║     █████╔╝ ███████║██║     ██║    ██████╔╝██████╔╝██║   ██║   ║"},{type:"output",content:"║     ██╔═██╗ ██╔══██║██║     ██║    ██╔═══╝ ██╔══██╗██║   ██║   ║"},{type:"output",content:"║     ██║  ██╗██║  ██║███████╗██║    ██║     ██║  ██║╚██████╔╝   ║"},{type:"output",content:"║     ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝    ╚═╝     ╚═╝  ╚═╝ ╚═════╝    ║"},{type:"output",content:"╠════════════════════════════════════════════════════════════════╣"},{type:"output",content:"║  🔒 CyberSec Pro - Web-based Kali Linux Terminal                ║"},{type:"output",content:'║  Type "help" for available commands                            ║'},{type:"output",content:"╚════════════════════════════════════════════════════════════════╝"},{type:"output",content:""}]),[h,i]=o.useState(""),[l,b]=o.useState([]),[c,d]=o.useState(-1),[y,f]=o.useState(!0);o.useEffect(()=>{p.current&&(p.current.scrollTop=p.current.scrollHeight)},[m]),o.useEffect(()=>{var s;(s=u.current)==null||s.focus()},[]);const g=async s=>{const r=s.trim();if(!r)return;n(t=>[...t,{type:"input",content:`┌──(kali㉿cybersec)-[~]
...
//# sourceMappingURL=TerminalPage-CNPAe94r.js.map
