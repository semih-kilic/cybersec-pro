import{j as e}from"./query-CnDYISbB.js";import{r as s,d as Ne,c as we,L as Se}from"./router-CDeefzIX.js";import{H as ke}from"./Header-DaS7ey8-.js";import{a as U}from"./api-CyeANQFZ.js";import{l as Ce,w as _e,a as Ee,u as Le}from"./index-DchFOGCQ.js";import"./charts-NA80FkOZ.js";import"./i18n-Dj3n_vXi.js";import"./motion-mHIBlpFh.js";const Te=typeof window<"u"&&window.__WS_URL__||"";function $e(j={}){const{autoConnect:y=!0,reconnection:_=!0,reconnectionAttempts:v=5,reconnectionDelay:I=1e3}=j,m=s.useRef(null),[i,A]=s.useState(!1),[T,R]=s.useState(!1),[O,N]=s.useState(null),[g,P]=s.useState(null),[x,$]=s.useState([]),[c,b]=s.useState(null),r=s.useCallback(()=>{var u;if((u=m.current)!=null&&u.connected)return;R(!0),N(null);const o=Ce(Te+"/scans",{reconnection:_,reconnectionAttempts:v,reconnectionDelay:I,transports:["websocket","polling"],withCredentials:!0});o.on("connect",()=>{console.log("🔌 WebSocket connected:",o.id),A(!0),R(!1),N(null)}),o.on("disconnect",l=>{console.log("🔌 WebSocket disconnected:",l),A(!1),l==="io server disconnect"&&N("Server disconnected")}),o.on("connect_error",l=>{console.error("🔌 WebSocket error:",l.message),R(!1),N(l.message)}),o.on("scan_progress",l=>{console.log("📊 Scan progress:",l),P(l)}),o.on("scan_output",l=>{$(G=>[...G.slice(-500),l])}),o.on("scan_complete",l=>{console.log("✅ Scan complete:",l),b(l)}),o.on("scan_status",l=>{P(l)}),o.on("error",l=>{N(l.message)}),m.current=o},[_,v,I]),W=s.useCallback(()=>{m.current&&(m.current.disconnect(),m.current=null,A(!1))},[]),w=s.useCallback(o=>{var u;(u=m.current)!=null&&u.connected&&m.current.emit("join_scan",{scan_id:o})},[]),F=s.useCallback(o=>{var u;(u=m.current)!=null&&u.connected&&m.current.emit("leave_scan",{scan_id:o})},[]),S=s.useCallback(o=>{var u;(u=m.current)!=null&&u.connected&&m.current.emit("subscribe_user",{user_id:o})},[]),E=s.useCallback(o=>{var u;(u=m.current)!=null&&u.connected&&m.current.emit("request_status",{scan_id:o})},[]),a=s.useCallback(()=>{$([]),P(null),b(null)},[]);return s.useEffect(()=>(y&&r(),()=>{W()}),[y,r,W]),{connected:i,connecting:T,error:O,connect:r,disconnect:W,subscribeScan:w,unsubscribeScan:F,subscribeUser:S,scanProgress:g,scanOutput:x,scanComplete:c,requestStatus:E,clearOutput:a}}function Me(j){const y=$e({autoConnect:!!j});return s.useEffect(()=>{if(j&&y.connected)return y.subscribeScan(j),y.requestStatus(j),()=>{y.unsubscribeScan(j)}},[j,y.connected]),{connected:y.connected,progress:y.scanProgress,output:y.scanOutput,complete:y.scanComplete,error:y.error}}const Z=[{key:"INITIALIZING",label:"Initializing",icon:"⚙️"},{key:"RESOLVING_TARGET",label:"Resolving Target",icon:"🌐"},{key:"PREPARING_TOOL",label:"Preparing Tool",icon:"🔧"},{key:"EXECUTING",label:"Executing Scan",icon:"🚀"},{key:"PARSING_OUTPUT",label:"Parsing Results",icon:"📊"},{key:"SAVING_RESULTS",label:"Saving Findings",icon:"💾"},{key:"COMPLETED",label:"Complete",icon:"✅"}],Re=({scanId:j,isRunning:y=!1,className:_=""})=>{const[v,I]=s.useState(null),[m,i]=s.useState(new Set),[A,T]=s.useState([]),[R,O]=s.useState(!1),N=s.useRef(null);s.useEffect(()=>{I(null),i(new Set),T([]),O(!1),N.current=null},[j]),s.useEffect(()=>{if(!j)return;const x=c=>{if((c==null?void 0:c.scan_id)!==j)return;const b=c.phase,r=c.description||"",W=c.progress||0,w={phase:b,description:r,progress:W,timestamp:Date.now()};N.current&&N.current!==b&&i(S=>{const E=new Set(S);return E.add(N.current),E});const F=Z.findIndex(S=>S.key===b);F>0&&i(S=>{const E=new Set(S);for(let a=0;a<F;a++)E.add(Z[a].key);return E}),b==="FAILED"&&O(!0),b==="COMPLETED"&&i(new Set(Z.map(S=>S.key))),I(w),T(S=>[...S,w]),N.current=b},$=_e.on("scan_phase_update",x);return()=>{$()}},[j]);const g=x=>R&&(v==null?void 0:v.phase)===x?"failed":m.has(x)?"completed":(v==null?void 0:v.phase)===x?"active":"pending";if(!j)return null;const P=(v==null?void 0:v.progress)||0;return e.jsxs("div",{className:`scan-progress-stepper ${_}`,children:[e.jsxs("div",{className:"progress-bar-container",children:[e.jsx("div",{className:"progress-bar-bg",children:e.jsx("div",{className:`progress-bar-fill ${R?"failed":""}`,style:{width:`${P}%`}})}),e.jsxs("span",{className:"progress-text",children:[P,"%"]})]}),e.jsx("div",{className:"stepper-container",children:Z.filter(x=>x.key!=="COMPLETED"||m.has("COMPLETED")).map((x,$)=>{const c=g(x.key),b=A.find(r=>r.phase===x.key);return e.jsxs("div",{className:`step step-${c}`,children:[$>0&&e.jsx("div",{className:`step-connector ${c==="completed"||c==="active"?"active":""}`}),e.jsxs("div",{className:`step-indicator ${c}`,children:[c==="completed"&&e.jsx("svg",{className:"check-icon",viewBox:"0 0 20 20",fill:"currentColor",children:e.jsx("path",{fillRule:"evenodd",d:"M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z",clipRule:"evenodd"})}),c==="active"&&e.jsx("div",{className:"pulse-dot"}),c==="failed"&&e.jsx("svg",{className:"fail-icon",viewBox:"0 0 20 20",fill:"currentColor",children:e.jsx("path",{fillRule:"evenodd",d:"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z",clipRule:"evenodd"})}),c==="pending"&&e.jsx("span",{className:"step-number",children:$+1})]}),e.jsxs("div",{className:"step-content",children:[e.jsxs("div",{className:"step-label",children:[e.jsx("span",{className:"step-icon",children:x.icon}),e.jsx("span",{className:"step-title",children:x.label})]}),(c==="active"||c==="completed"||c==="failed")&&b&&e.jsx("div",{className:"step-description",children:b.description})]})]},x.key)})}),e.jsx("style",{children:`
...
//# sourceMappingURL=ScanExecutionPage-CdYNOwq-.js.map
