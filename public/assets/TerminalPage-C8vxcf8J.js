import{j as e}from"./index-fb5ymOXG.js";import{r as o}from"./router-CDeefzIX.js";import{H as k}from"./Header-B6dwo3Ly.js";function T(){const p=o.useRef(null),u=o.useRef(null),[m,n]=o.useState([{type:"output",content:"╔════════════════════════════════════════════════════════════════╗"},{type:"output",content:"║     ██╗  ██╗ █████╗ ██╗     ██╗    ██████╗ ██████╗  ██████╗    ║"},{type:"output",content:"║     ██║ ██╔╝██╔══██╗██║     ██║    ██╔══██╗██╔══██╗██╔═══██╗   ║"},{type:"output",content:"║     █████╔╝ ███████║██║     ██║    ██████╔╝██████╔╝██║   ██║   ║"},{type:"output",content:"║     ██╔═██╗ ██╔══██║██║     ██║    ██╔═══╝ ██╔══██╗██║   ██║   ║"},{type:"output",content:"║     ██║  ██╗██║  ██║███████╗██║    ██║     ██║  ██║╚██████╔╝   ║"},{type:"output",content:"║     ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝    ╚═╝     ╚═╝  ╚═╝ ╚═════╝    ║"},{type:"output",content:"╠════════════════════════════════════════════════════════════════╣"},{type:"output",content:"║  🔒 CyberSec Pro - Web-based Kali Linux Terminal                ║"},{type:"output",content:'║  Type "help" for available commands                            ║'},{type:"output",content:"╚════════════════════════════════════════════════════════════════╝"},{type:"output",content:""}]),[h,i]=o.useState(""),[l,b]=o.useState([]),[c,d]=o.useState(-1),[y,f]=o.useState(!0);o.useEffect(()=>{p.current&&(p.current.scrollTop=p.current.scrollHeight)},[m]),o.useEffect(()=>{var s;(s=u.current)==null||s.focus()},[]);const g=async s=>{const r=s.trim();if(!r)return;n(t=>[...t,{type:"input",content:`┌──(kali㉿cybersec)-[~]
...
//# sourceMappingURL=TerminalPage-C8vxcf8J.js.map
