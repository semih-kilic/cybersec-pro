...
<a href="https://cybersecpro.semihkilic.com/dashboard/scans" style="display:inline-block;padding:14px 36px;background:linear-gradient(135deg,#00ff88,#00d4ff);color:#0a0a0a;text-decoration:none;font-weight:bold;border-radius:50px;margin:10px 0">View Results</a>
...
<p style="color:#4a5568;font-size:12px">© 2026 CyberSec Professional</p>
    ...
    let plain = format!(
        ...
        name, tool_name, target, status, findings_text
    );
