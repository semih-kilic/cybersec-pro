---
title: "How We Built a Rust-Powered Scan Engine with gRPC for 88 Security Tools"
date: 2026-08-18
...
# How We Built a Rust-Powered Scan Engine with gRPC for 88 Security Tools
...
The challenge wasn't just wrapping CLI tools in a web UI. It was building a platform that could orchestrate 88 different security tools at scale, with proper auth, audit logging, and compliance. And it had to be fast.
...
For the frontend tool catalog (88 tools), we built a WASM module:
...
The search runs entirely client-side — no API round-trip for filtering 88 tools. Users notice instant results.
