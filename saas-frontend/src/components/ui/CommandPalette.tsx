...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(() => {
    ...
    return [
      ...
      { id: 'nav-tools', label: t('nav.tools', 'Tools'), description: '396 security tools', icon: <NavIcon />, action: nav('/dashboard/tools'), category: 'navigation' as const, keywords: ['kali', 'security', 'catalog'] },
