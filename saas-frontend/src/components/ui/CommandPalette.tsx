...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(() => {
    ...
    return [
      ...
      { id: 'nav-tools', label: t('nav.tools', 'Tools'), description: t('nav.toolsDesc', 'Security tools catalog'), icon: <NavIcon />, action: nav('/dashboard/tools'), category: 'navigation' as const, keywords: ['kali', 'security', 'catalog'] },
