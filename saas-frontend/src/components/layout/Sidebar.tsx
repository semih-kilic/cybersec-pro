...
const navigation = [
  ...
  { nameKey: 'nav.news', href: '/dashboard/news', icon: NewsIcon },
...
const bottomNav = [
  ...
  { nameKey: 'nav.documentation', href: 'https://cyber-sec-pro.com/en/docs/', icon: DocsIcon, external: true },
];
    ...
    >
      ...
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center shadow-lg shadow-cyan-500/20 flex-shrink-0">
