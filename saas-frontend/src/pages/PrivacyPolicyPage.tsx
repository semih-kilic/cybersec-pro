      ...
      <div className="max-w-4xl mx-auto px-4 pb-20">
        <div className="bg-gray-800/50 rounded-2xl p-8 md:p-12 border border-gray-700">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">2. Data Controller</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">3. Data We Collect</h2>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>Scan targets and results (encrypted at rest)</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">4. Legal Basis for Processing</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">5. Your Rights Under GDPR</h2>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Scan results: Retained for 90 days, then automatically purged</li>
                <li>Access logs: Retained for 12 months for security purposes</li>
                <li>Payment records: Retained as required by tax law (typically 7 years)</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">7. Data Transfers</h2>
              <p>Your data is processed within the European Union. If data must be transferred outside the EU/EEA, we ensure appropriate safeguards are in place (Standard Contractual Clauses or adequacy decisions per Art. 46 GDPR).</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 mt-2">
                ...
                <li>Automated data backup with encryption</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">10. Supervisory Authority</h2>
              <p>If you believe your data protection rights have been violated, you have the right to lodge a complaint with a supervisory authority in the EU Member State of your habitual residence, place of work, or place of the alleged infringement.</p>
            </section>
