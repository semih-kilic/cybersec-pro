...
export function LandingPage() {
  ...
  const replaceCounts = (s: string) => {
    let out = s;
    if (totalTools) out = out.replace(/\b(401|396|811|\d{3,4})(?=\s*(Professional|professional|penetration|Penetration|Penetrationstest|outils|herramientas|strumenti|Kali))/g, String(totalTools));
